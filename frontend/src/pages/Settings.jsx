    ...
    <div className="space-y-4 sm:space-y-6 animate-fade-in">
      ...
      {activeTab === 'security' && (
        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-6 max-w-2xl">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-surface-container-low rounded-lg"><div><p className="text-body-md font-medium text-on-surface">Supabase Authentication</p><p className="text-label-md text-on-surface-variant">Email/password admin login active</p></div><span className="px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 text-status-badge">Active</span></div>
            <div className="flex items-center justify-between p-4 bg-surface-container-low rounded-lg"><div><p className="text-body-md font-medium text-on-surface">Supabase Real-Time Sync</p><p className="text-label-md text-on-surface-variant">Live data sync across all devices</p></div><span className="px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 text-status-badge">Active</span></div>
